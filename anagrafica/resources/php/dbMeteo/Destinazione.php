<?php
    ...
    class Destinazione extends GenericEntity{
                ...
                $output .= '<thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>DataInizio</td>
                                <th>
                                    <input type="text" name="DataInizio" value="'. date('Y-m-d H:m:s') .'" />
                                </th>
                            </tr>';
            }
            $output .='        <tr>
                                    <td>DataFine</td>
                                    <th>
                                        <input type="text" name="DataFine" value="'.$item['DataFine'].'" />
                                    </th>
                                </tr>
                                <tr>
                                    <td>Note</td>
                                    <td>'.'<textarea id="Note" name="Note">'.$item['Note'].'</textarea></td>
                                </tr>
                            </tbody>
                       </table>';
        ...
        function getListaDestinazioni(){
            $sql = 'SELECT DISTINCT Destinazione, IDdestinazione FROM A_Destinazioni ORDER BY Destinazione;';
