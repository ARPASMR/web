...
#==============================================================================
#  	query al DBunico per estrarre IDsensori che importiamo nel DBmeteo
#
#       select * from DBCum..RichiesteAuto_Sensori where IdRichiesta = 104
# 
#==============================================================================
...
if (length(DBunico_SensStaz$IdSensore[!aux])>0) {
  cat(rbind(as.vector(DBunico_SensStaz$IdSensore[!aux]),
              ...
              ",",
              as.vector(DBunico_SensStaz$IdTipologia[!aux]),
              ",",
